...
import TamEkran from 'Components/TamEkran';
...
const Player = () => {
    ...
    return (
        <div className='flex px-4 justify-between items-center h-full'>
                            ...
                            <div className="flex items-center mr-3">
                                {
                                    ...
                                    className='w-6 h-6 absolute opacity-0 group-hover:opacity-60 hover:!opacity-100 hover:scale-[1.06] top-1 right-1 bg-black  flex items-center justify-center rounded-full rotate-90'>
            ...
            <div ref={fsRef}>
                {isFullscreen&&<div>
                    <TamEkran toggle={toggle} state={state} controls={controls} volumeIcon={volumeIcon}/>
                    </div>}
            </div>
        </div>
    )
