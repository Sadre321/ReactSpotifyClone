...
const HomeIcon = ({ size }) => {
    return (
        <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 24 24" width={size} height={size} class="Svg-sc-ytk21e-0 bneLcE" fill="currentColor">
...
const SearchIcon = ({ size }) => {
    return (
        <svg data-encore-id="icon" role="img" aria-hidden="true" class="Svg-sc-ytk21e-0 bHdpig M9l40ptEBXPm03dU3X1k" width={size} height={size} fill="currentColor" viewBox="0 0 24 24">
...
const LibraryIcon = ({ size }) => {
    return (
        <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 24 24" width={size} height={size} fill="currentColor" class="Svg-sc-ytk21e-0 bneLcE">
...
const PlusIcon = ({ size }) => {
    return (
        <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16" width={size} height={size} fill="currentColor" class="Svg-sc-ytk21e-0 bneLcE">
            <path d="M15.25 8a.75.75 0 0 1-.75.75H8.75v5.75a.75.75 0 0 1-1.5 0V8.75H1.5a.75.75 0 0 1 0-1.5h5.75V1.5a.75.75 0 0 1 1.5 0v5.75h5.75a.75.75 0 0 1 .75.75z"></path>
        </svg>
    )
}

const HeartsIcon = ({size}) => {
	return (
		<svg viewBox="0 0 16 16" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
...
const DownloadIcon = ({ size }) => {
    return (
        <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16" width={size} height={size} fill="currentColor" class="Svg-sc-ytk21e-0 dYnaPI">
            ...
            <path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13z" /></svg>
...
const RightArrowIcon = ({ size }) => {
    return (
    <svg data-encore-id="icon" role="img" aria-hidden="true" width={size} height={size} viewBox="0 0 16 16" class="Svg-sc-ytk21e-0 cAMMLk" fill="currentColor">
        <path d="M8.47 1a.749.749 0 0 0-1.28-.47L0 7.99l7.53 7.521a.75.75 0 1 0 1.234-.815.75.75 0 0 0-.174-.243l-5.72-5.714h12.38a.75.75 0 1 0 0-1.498H3.41L8.59 1.529a.749.749 0 0 0 .22-.53z"/>
    </svg>
    )
}
