...
const Home = () => {
  ...
  return (
    <div className='grid gap-y-8'>
      <Sections title={"Recently Played"} more={"/blaa"} items={items}/>
      <Sections title={"Show To Try"} more={"/blaa"} items={items}/>
      <Sections title={"Made for Haydar"} more={"/blaa"} items={items}/>
    </div>
  )
}
